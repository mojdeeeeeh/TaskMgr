                    ...
                    <table class="table table-hover table-stripped" v-show="hasUser">
                        ...
                        <tbody>
                            <tr v-for="user in users">
                                ...
                                <td>
                                    <a class="btn btn-danger" href="#" data-record-id="user.id" @click="deleteUser(user)">&times;</a>
                                    <a class="btn btn-info" href="#" data-record-id="user.id" @click="showUpdateForm(user)">&plus;</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
